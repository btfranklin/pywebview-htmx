...
JS_BEHAVIOR_FRAGMENTS: list[tuple[int, tuple[str, ...]]] = [
    ...
    (48, ("window.pywebviewHtmx = {",)),
    (49, ("config,",)),
    (50, ("process: processPyWebviewHtmxNodes",)),
    (51, ("swap: pySwap",)),
    ...
    (54, ("function processPyWebviewHtmxNodes(root = document)",)),
    (55, ('if (!root || typeof root.querySelectorAll !== "function")',)),
    (56, ('root.querySelectorAll("[py-call]")',)),
    (57, ('element.getAttribute("data-pywebview-bound") === "true"',)),
    (58, ('element.setAttribute("data-pywebview-bound", "true")',)),
    (59, ('element.getAttribute("py-trigger") || "click"',)),
    (60, ('element.getAttribute("py-call")',)),
    (61, ('console.warn("PyWebview HTMX: py-call is empty"',)),
    ...
    (
        66,
        (
            'console.error("PyWebview HTMX: invalid JSON in data-py-params"',
            "return {};",
        ),
    ),
